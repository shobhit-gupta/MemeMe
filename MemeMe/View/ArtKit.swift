...
public class ArtKit : NSObject {
    ...
    public dynamic class func drawCameraButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 128, height: 128), resizing: ResizingBehavior = .aspectFit, isPressed: Bool = false) {
        ...
        if (notPressed) {
            ...
            fillPath.move(to: CGPoint(x: 107.52, y: 56.03))
            fillPath.addCurve(to: CGPoint(x: 100.05, y: 48.57), controlPoint1: CGPoint(x: 103.39, y: 56.03), controlPoint2: CGPoint(x: 100.05, y: 52.69))
            fillPath.addCurve(to: CGPoint(x: 107.52, y: 41.11), controlPoint1: CGPoint(x: 100.05, y: 44.45), controlPoint2: CGPoint(x: 103.39, y: 41.11))
            fillPath.addCurve(to: CGPoint(x: 114.99, y: 48.57), controlPoint1: CGPoint(x: 111.64, y: 41.11), controlPoint2: CGPoint(x: 114.99, y: 44.45))
            fillPath.addCurve(to: CGPoint(x: 107.52, y: 56.03), controlPoint1: CGPoint(x: 114.99, y: 52.69), controlPoint2: CGPoint(x: 111.64, y: 56.03))
            fillPath.close()
            fillPath.move(to: CGPoint(x: 64.26, y: 97.43))
            fillPath.addCurve(to: CGPoint(x: 36.19, y: 69.14), controlPoint1: CGPoint(x: 48.74, y: 97.43), controlPoint2: CGPoint(x: 36.19, y: 84.78))
            fillPath.addCurve(to: CGPoint(x: 64.26, y: 40.86), controlPoint1: CGPoint(x: 36.19, y: 53.54), controlPoint2: CGPoint(x: 48.74, y: 40.86))
            fillPath.addCurve(to: CGPoint(x: 92.33, y: 69.14), controlPoint1: CGPoint(x: 79.76, y: 40.86), controlPoint2: CGPoint(x: 92.33, y: 53.54))
            fillPath.addCurve(to: CGPoint(x: 64.26, y: 97.43), controlPoint1: CGPoint(x: 92.33, y: 84.78), controlPoint2: CGPoint(x: 79.76, y: 97.43))
            fillPath.close()
            fillPath.move(to: CGPoint(x: 115.85, y: 33.52))
            fillPath.addLine(to: CGPoint(x: 86.62, y: 33.52))
            fillPath.addLine(to: CGPoint(x: 83.01, y: 24.62))
            fillPath.addCurve(to: CGPoint(x: 75.17, y: 19), controlPoint1: CGPoint(x: 81.79, y: 21.75), controlPoint2: CGPoint(x: 78.26, y: 19))
            fillPath.addLine(to: CGPoint(x: 52.72, y: 19))
            fillPath.addCurve(to: CGPoint(x: 44.9, y: 24.62), controlPoint1: CGPoint(x: 49.63, y: 19), controlPoint2: CGPoint(x: 46.11, y: 21.75))
            fillPath.addLine(to: CGPoint(x: 41.27, y: 33.52))
            fillPath.addLine(to: CGPoint(x: 11.98, y: 33.52))
            fillPath.addCurve(to: CGPoint(x: 4, y: 38.69), controlPoint1: CGPoint(x: 8.89, y: 33.52), controlPoint2: CGPoint(x: 4, y: 35.58))
            fillPath.addLine(to: CGPoint(x: 4, y: 102.85))
            fillPath.addCurve(to: CGPoint(x: 11.98, y: 109), controlPoint1: CGPoint(x: 4, y: 105.99), controlPoint2: CGPoint(x: 8.89, y: 109))
            fillPath.addLine(to: CGPoint(x: 115.85, y: 109))
            fillPath.addCurve(to: CGPoint(x: 124, y: 102.85), controlPoint1: CGPoint(x: 118.95, y: 109), controlPoint2: CGPoint(x: 124, y: 105.99))
            fillPath.addLine(to: CGPoint(x: 124, y: 38.69))
            fillPath.addCurve(to: CGPoint(x: 115.85, y: 33.52), controlPoint1: CGPoint(x: 124, y: 35.58), controlPoint2: CGPoint(x: 118.95, y: 33.52))
            fillPath.close()
            strokeColor.setStroke()
            ...
            let fill2Path = UIBezierPath(ovalIn: CGRect(x: -18, y: -18.25, width: 36, height: 36.5))
            fillColor.setFill()
            fill2Path.fill()
    ...
    public dynamic class func drawAlbumButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 128, height: 128), resizing: ResizingBehavior = .aspectFit, isPressed: Bool = false) {
        ...
        if (isPressed) {
            ...
            let pressedStateRect = CGRect(x: 11, y: 4, width: 105, height: 120)
            let pressedStateStyle = NSMutableParagraphStyle()
            pressedStateStyle.alignment = .left
            let pressedStateFontAttributes = [NSFontAttributeName: UIFont(name: "Ionicons", size: 120)!, NSForegroundColorAttributeName: textForeground, NSParagraphStyleAttributeName: pressedStateStyle]

            "".draw(in: pressedStateRect, withAttributes: pressedStateFontAttributes)
        ...
        if (notPressed) {
            //// normalState Drawing
            let normalStateRect = CGRect(x: 11, y: 4, width: 105, height: 120)
            let normalStateStyle = NSMutableParagraphStyle()
            normalStateStyle.alignment = .left
            let normalStateFontAttributes = [NSFontAttributeName: UIFont(name: "Ionicons", size: 120)!, NSForegroundColorAttributeName: textForeground, NSParagraphStyleAttributeName: normalStateStyle]

            "".draw(in: normalStateRect, withAttributes: normalStateFontAttributes)
        }
    ...
    public dynamic class func drawPopularButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 128, height: 128), resizing: ResizingBehavior = .aspectFit, isPressed: Bool = false) {
        ...
        if (isPressed) {
            ...
            let pressedStatePath = UIBezierPath()
            pressedStatePath.move(to: CGPoint(x: 63.55, y: 16))
            pressedStatePath.addLine(to: CGPoint(x: 74.65, y: 50.72))
            pressedStatePath.addLine(to: CGPoint(x: 111.1, y: 50.55))
            pressedStatePath.addLine(to: CGPoint(x: 81.51, y: 71.84))
            pressedStatePath.addLine(to: CGPoint(x: 92.94, y: 106.45))
            pressedStatePath.addLine(to: CGPoint(x: 63.55, y: 84.89))
            pressedStatePath.addLine(to: CGPoint(x: 34.16, y: 106.45))
            pressedStatePath.addLine(to: CGPoint(x: 45.59, y: 71.84))
            pressedStatePath.addLine(to: CGPoint(x: 16, y: 50.55))
            pressedStatePath.addLine(to: CGPoint(x: 52.45, y: 50.72))
            pressedStatePath.close()
            fillColor.setFill()
            pressedStatePath.fill()
        ...
        if (notPressed) {
            //// normalState Drawing
            let normalStatePath = UIBezierPath()
            normalStatePath.move(to: CGPoint(x: 63.55, y: 16))
            normalStatePath.addLine(to: CGPoint(x: 74.65, y: 50.72))
            normalStatePath.addLine(to: CGPoint(x: 111.1, y: 50.55))
            normalStatePath.addLine(to: CGPoint(x: 81.51, y: 71.84))
            normalStatePath.addLine(to: CGPoint(x: 92.94, y: 106.45))
            normalStatePath.addLine(to: CGPoint(x: 63.55, y: 84.89))
            normalStatePath.addLine(to: CGPoint(x: 34.16, y: 106.45))
            normalStatePath.addLine(to: CGPoint(x: 45.59, y: 71.84))
            normalStatePath.addLine(to: CGPoint(x: 16, y: 50.55))
            normalStatePath.addLine(to: CGPoint(x: 52.45, y: 50.72))
            normalStatePath.close()
            fillColor.setFill()
